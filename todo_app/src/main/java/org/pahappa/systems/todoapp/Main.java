...
//				System.out.println("Task Status: " + task.getStatus());
	...
	private static void search() {
		...
		try {
			...
			if (resultset.next()) {
				String namet = resultset.getString("taskName");
				String descp = resultset.getString("taskDesc");
				System.out.println("the task exists: "+ namet + "     " + descp);
			}else {
				System.out.println("no such task or description");
			}
